...
| C-16 | Endpoint only on fixed upstream 1,200 ms token silence or EOF. | Implemented | It avoids synthetic duration cuts and makes each Parakeet slice correspond to the recorded first-pass boundary. Pause-free latency remains unbounded and documented. |
